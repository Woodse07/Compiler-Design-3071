...
#line 142 "roman.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "ONE", "FOUR", "FIVE", "NINE", "TEN",
  "FOURTY", "FIFTY", "NINETY", "HUNDRED", "FOUR_HUNDRED", "FIVE_HUNDRED",
  "NINE_HUNDRED", "THOUSAND", "EOL", "$accept", "roman_numeral", "numeral",
  "term", YY_NULLPTR
};
#endif
...
#line 15 "roman.y" /* yacc.c:1646  */
    { printf("%d\n", (yyvsp[-1])); }
#line 1222 "roman.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 19 "roman.y" /* yacc.c:1646  */
